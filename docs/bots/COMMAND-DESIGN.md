...
type: guidance
description: "Best practices for creating effective Claude Code slash commands, including mandatory skill-first pattern, context efficiency, and supervisor orchestration patterns."
tags:
  - command
  - slash-command
  - best-practices
