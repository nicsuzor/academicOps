...
type: guidance
description: "Evidence-based principles for effective context management in Claude Code components, including token efficiency strategies, curated context patterns, and context pollution solutions."
tags:
  - context-engineering
  - best-practices
  - token-efficiency
