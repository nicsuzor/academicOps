...
type: guidance-index
description: "Evidence-based guidance for creating effective Claude Code components (subagents, skills, commands, hooks) that are concise, performant, and maintainable. Index file referencing modular topic chunks."
tags:
  - best-practices
  - agent-design
  - framework
