...
| File                          | Event                               | Purpose          |
| ----------------------------- | ----------------------------------- | ---------------- |
| [[session_env_setup.sh        | hooks/session_env_setup.sh]]        | SessionStart     |
| [[sessionstart_load_axioms.py | hooks/sessionstart_load_axioms.py]] | SessionStart     |
| [[user_prompt_submit.py       | hooks/user_prompt_submit.py]]       | UserPromptSubmit |
| [[policy_enforcer.py          | hooks/policy_enforcer.py]]          | PreToolUse       |
| [[autocommit_state.py         | hooks/autocommit_state.py]]         | PostToolUse      |
| [[unified_logger.py           | hooks/unified_logger.py]]           | ALL events       |
