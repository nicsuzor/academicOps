...
❌ **NEVER** say "I'll fix this" ❌ **NEVER** say "I'll correct this"\
❌ **NEVER** say "Let me investigate and fix" ❌ **NEVER** modify scripts or code ❌ **NEVER** create workarounds ❌ **NEVER** skip to the next step ❌ **NEVER** improvise solutions

## REQUIRED RESPONSE TO ERRORS

✅ Say: "Step [N] failed: [error]" ✅ Say: "Waiting for your instruction on how to proceed." ✅ Stop all execution ✅ Wait for user response
