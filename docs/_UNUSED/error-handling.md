...
**Examples**: File not found, MCP connection failed, API rate limits **Response**:
...
**Examples**: API response missing expected fields, malformed data **Response**:
...
**Examples**: Conflicting instructions, impossible requirements **Response**:
...
**Examples**: 3 of 5 tasks completed, some emails processed **Response**:
