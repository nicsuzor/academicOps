...
- Quick reference: [[bots/STYLE-QUICK.md]]
- Comprehensive guide: [[bots/STYLE.md]]

## Communicating with me:

- Read [[bots/ACCOMMODATIONS.md]]
...
- **Agent framework**: `nicsuzor/academicOps` (PUBLIC, at `aOps/`)
- **GitHub issues**: ALL framework issues → `nicsuzor/academicOps`
