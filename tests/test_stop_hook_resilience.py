...
def test_validate_stop_iteration_limit():
    ...
    try:
        ...
        assert "MAX_ITERATIONS_FILE" in script_content, (
            "Script should have iteration counter"
        )
        assert "MAX_ALLOWED_ITERATIONS" in script_content, (
            "Script should have max iterations"
        )
        assert "check_iteration_limit" in script_content, (
            "Script should check iteration limit"
        )
