...
class TestHydrationRecencyGate:
    ...
    def test_allows_if_not_tracked(self, mock_session_state):
        ...
        mock_session_state.get_or_create_session_state.return_value = {"hydration": {}}
...
class TestPostCriticTrigger:
    def test_detects_critic_delegate(self, mock_session_state):
        ...
        ctx = GateContext(
            "sess1",
            "PostToolUse",
            {"tool_name": "delegate_to_agent", "tool_input": {"agent_name": "critic"}},
        )
    ...
    def test_detects_critic_task(self, mock_session_state):
        ...
        ctx = GateContext(
            "sess1",
            "PostToolUse",
            {"tool_name": "Task", "tool_input": {"subagent_type": "critic"}},
        )
