...
| ---------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [[test_reflexive_loop.py]]   | Compliance gate fires during normal agent operation. Validates the self-reflexive monitoring loop works.                                                                                                                            |
...
| test_hook_sequence.py        | Hooks fire at correct lifecycle events: SessionStart (session completes), UserPromptSubmit (hydrator temp file created), PostToolUse (audit file created).                                                                          |
...
| test_compliance_detection.py | Compliance agent produces substantive, well-formed audit output. Uses semantic validation (not keyword matching): checks Session Context has content lines, AXIOMS has numbered items, HEURISTICS has H-items, no repeated headers. |
...
| Compliance                     | ~30%     | Audit structure verified; violation detection not yet tested                         |
...
- Other subagent types (planner, explore)
