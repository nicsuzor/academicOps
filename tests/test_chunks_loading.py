...
- ACADEMICOPS - Points to framework root
- ACADEMICOPS_PERSONAL - Points to personal repository
...
"""
    ...
    def test_academicops_env_var_available_to_agent(self, tmp_path):
        """
        VALIDATES: $ACADEMICOPS environment variable available to agent

        Test structure:
        - Set ACADEMICOPS env var pointing to test framework
        ...
        - Agent can reference $ACADEMICOPS in context
