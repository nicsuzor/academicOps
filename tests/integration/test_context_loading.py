...
def run_claude_headless(prompt: str, timeout: int = 120) -> dict:
...
class TestUserContextLoading:
    ...
    def test_project_awareness(self):
        ...
        assert any(word in result_lower for word in ["research", "academic", "framework", "python", "computational"]), \
    ...
    def test_workflow_preferences(self):
        ...
        assert "adhd" in result_lower or "concise" in result_lower or "brief" in result_lower, \
            f"Expected ADHD/communication preferences, got: {result['result']}"

    def test_primary_project_priority(self):
...
class TestCoreInstructionsLoading:
    ...
    def test_fail_fast_philosophy(self):
    ...
    def test_repository_structure_awareness(self):
...
class TestContextPriority:
    ...
    def test_user_projects_over_framework(self):
        ...
        good_indicators = ["buttermilk", "automod", "research", "project", "ask", "which", "clarif"]
        ...
        has_only_bad = not has_good and any(indicator in result_lower for indicator in bad_indicators)
...
class TestContextCompleteness:
    ...
    def test_knows_execution_environment(self):
    ...
    def test_knows_project_submodules(self):
...
class TestQuickSmokeTest:
    ...
    def test_whose_repository_smoke_test(self):
        """
