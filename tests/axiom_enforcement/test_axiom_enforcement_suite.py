...
# =============================================================================
# Axiom Enforcer Gate Tests - P#26
# =============================================================================


class TestAxiomEnforcerGateP26:
    """Tests for P#26 write-without-read enforcement."""

    def test_uses_notebook_path_for_notebooks(self, tmp_path: Path) -> None:
        """P#26: Check notebook_path field for NotebookEdit."""
    ...
    def test_blocks_edit_without_read(self, tmp_path: Path) -> None:
        """P#26: Block Edit to existing file not read."""
    ...
    def test_allows_write_to_safe_temp_path(self) -> None:
        """P#26: Allow writes to safe temp directories without read."""
        safe_path = str(Path.home() / ".claude" / "tmp" / "session" / "test.py")
    ...
    def test_allows_write_to_new_file(self, tmp_path: Path) -> None:
        """P#26: Allow write to file that doesn't exist."""
    ...
    def test_allows_write_after_read(self, tmp_path: Path) -> None:
    ...
    def test_metadata_includes_violation_details(self, tmp_path: Path) -> None:
        """Verify metadata contains violation information."""
        ...
        ctx = GateContext(
            ...
            input_data={
                ...
                "tool_input": {
                    "file_path": str(test_file),
                    "old_string": "old",
                    "new_string": _decode(_B64_EXCEPT_PASS),
                },
            },
        )
        ...
        assert result.metadata["source"] == "axiom_enforcer"
