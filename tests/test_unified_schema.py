...
def test_task_schema():
    ...
    task = {
        "id": f"{datetime.now(UTC).strftime('%Y%m%d')}-abc12345",
        ...
        "preview": email_data["bodyPreview"][:160]
        ...
        "source": {
            ...
            "attachment_names": [
                a["fileName"] for a in email_data.get("attachments", [])
            ],
    ...
    print("  - No separate processed email file needed!")
    print()
...
def test_backwards_compatibility():
    ...
    old_task = {"id": "20250120-old12345", "metadata": {"email_id": "OLD_EMAIL_123"}}

    # New schema
    new_task = {
        "id": "20250120-new67890",
        "source": {"type": "email", "email_id": "NEW_EMAIL_456"},
    }
