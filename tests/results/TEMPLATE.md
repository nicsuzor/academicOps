...
[List any CRITICAL test failures and immediate impact]

### Patterns Observed

[Note any patterns in successes/failures]

### Documentation Issues

[Note any ambiguities or gaps found in docs/INSTRUCTIONS.md]

## Recommended Actions

- [ ] **[PRIORITY]**: [Specific action item with owner and issue reference]
- [ ] **[PRIORITY]**: [Specific action item with owner and issue reference]

## Links

- Test specification: `bot/tests/prompts/CONTEXT-AWARENESS-TESTS.md`
- Raw outputs: `bot/tests/results/test*_YYYYMMDD.txt`
- Related issues: #64, #66, #67
