...
that `plugins/aops-core/workflows/` was an unauthorized location for instructions. It is
...
WORKFLOW = PROJECT_ROOT / "plugins" / "aops-core" / "workflows" / "archive" / "email-triage.md"
...
def test_the_template_reaches_the_client_artifact(client, tmp_path):
    ...
    built = dist_root / f"aops-core-{client}" / "workflows" / "archive" / "email-triage.md"
