...
class TestAsciiTreeGenerator:
    def test_generate_simple_tree(self):
        ...
        root = TaskIndexEntry(
            id="aops-nn1l",
            title="Write TJA paper",
            type="epic",
            status="active",
            priority=1,
            order=0,
            parent=None,
            children=["aops-lr01", "aops-da01", "aops-wr01", "aops-wr02"],
            depends_on=[],
            blocks=[],
            path="",
        )
        ...
        lr2 = TaskIndexEntry(
            id="aops-lr02",
            title="Search databases for [terms]",
            type="action",
            status="done",
            priority=2,
            order=0,
        ...
        def get_task_side_effect(tid):
            mapping = {"aops-nn1l": root, "aops-lr01": lr, "aops-lr02": lr2, "aops-lr03": lr3}
