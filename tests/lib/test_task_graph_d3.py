...
# We use abspath relative to the current working directory (repo root)
sys.path.append(os.path.abspath("lib/overwhelm"))

from task_graph_d3 import generate_graph_from_tasks  # noqa: E402
