...
**Purpose**: Validate that agents starting in the parent repo (`${ACA}/`) immediately understand their context and know where to find required information.
...
- **SHOULD** use absolute paths starting with `${ACA}/`
