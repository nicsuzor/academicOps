...
def test_core_agent_transformation_for_gemini(agent_name):
    ...
    if "AXIOMS.md" in content:
        ...
        # <plugin>/.agents/AXIOMS.md, so the import must resolve at
        # ${extensionPath}/.agents/AXIOMS.md (no parent-of-root path).
        # Regression guard for #aops-75543e66.
        assert "@${extensionPath}/.agents/AXIOMS.md" in final
        assert "/../.agents/" not in final
