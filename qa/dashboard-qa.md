...
| E6.7 | Dashboard reduces overwhelm | Emotional check                 | Opening the dashboard makes you feel _more_ oriented, not _more_ stressed                   |
...
| E7.8 | Auto-refresh works           | Wait 5 minutes or check the timer                                      |
...
6. **Emotional assessment**: Does the dashboard feel _calmer_ to use? Does it reduce cognitive load or add to it? This is subjective but critical for an ADHD tool.
