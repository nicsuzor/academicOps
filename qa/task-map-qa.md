...
- Fresh `graph.json` from fast-indexer: `aops reindex` or equivalent
...
6. **User-experience judgment**: Does it actually *feel* better to use? Not just "does the check pass" but "would this help Nic orient faster?"
