...
4. **Auto-complete clear cases**: Only when step 3a confirms correspondence **and** step 3b finds every acceptance criterion clearly met by the merged artifact, call `mcp__pkb__complete_task` with a completion note including the PR URL and merge timestamp as evidence.
