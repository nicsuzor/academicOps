...
| `/critic`           | skill   | "pre-hoc plan evaluation", "adversarial review", "plan review"                                                                                                                                          | no             | no         | conversational | framework                    | **DEPRECATED** — use `/strategic-review` (pauli + rbg + marsha pipeline)         |
...
| `/enforcer`         | skill   | "axiom compliance", "post-hoc review", "rules check", "ultra vires"                                                                                                                                     | no             | no         | execution      | framework                    | **DEPRECATED** — axiom compliance and ultra vires detection now handled by rbg   |
...
| `/qa`               | skill   | "verify", "QA check", "acceptance test", "quality check", "is it done", "validate work"                                                                                                                 | yes            | yes        | execution      | quality-assurance            | QA verification and test planning via marsha                                     |
...
| `/strategic-review` | skill   | "strategic review", "plan review", "adversarial review", "review this document", "review this proposal"                                                                                                 | no             | no         | conversational | framework, quality-assurance | Three-agent pipeline: pauli (strategic, iterative) → rbg (compliance) → marsha   |
