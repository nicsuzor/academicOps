...
Then call `mcp_pkb_update_task(id=task_id, updates={"status": "review", "body": synthesis_markdown})`.
...
Then call `mcp_pkb_update_task(id=task_id, updates={"status": "in_progress", "body": synthesis_markdown})` and re-enter Phase 1 with reviewer feedback.
...
Then call `mcp_pkb_update_task(id=task_id, updates={"status": "blocked", "body": synthesis_markdown})`.
