...
description: Non-negotiable rules for research, teaching, and publication contexts. Enforced by the academic standards agent.
---

# Academic Context Rules

These rules are non-negotiable when working in academic contexts (research, teaching, publication). They activate alongside the universal axioms when the work involves academic output.
