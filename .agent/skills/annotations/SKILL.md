...
description: Scan and process inline HTML comments for human-agent collaboration. Finds <!-- @human: --> or <!-- @user: --> comments and responds with dated <!-- @claude: --> replies.
...
```markdown
The court held that platforms must provide notice. <!-- @user: check if this applies post-DSA -->
```
