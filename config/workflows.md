...
permalink: config/workflows
tags: [framework, routing, config]
---

# Workflow Routing

Configurable policy for task classification and workflow selection. This is the "soft tissue" that can change independently of agent mechanisms.

**Read by**: hypervisor, intent-router
...
1. Add row to the table above with prose description of when to use
2. Update `hooks/guardrails.md` with type→guardrail mapping
3. No changes needed to agent definitions (they read this file)
