...
- NON-INTERACTIVE EXECUTION: When executing in a headless or non-interactive environment (e.g. polecat containers, CI/CD, no TTY), NEVER emit interactive prompts or wait for user keyboard input. All decision logic must have a documented automatic fallback path or hand back at partial status.
