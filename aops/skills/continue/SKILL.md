---
name: continue
description: "Pause and hand back to the user with work still IN PROGRESS \u2014 emit\
  \ a scannable resume summary and checkpoint the bound task, WITHOUT concluding.\
  \ Use /end-session or /dump to finish the task completely."
---
