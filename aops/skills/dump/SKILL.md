---
name: dump
description: "Emergency session bail \u2014 fast resume task + short handover, no\
  \ commit/PR/reflection. For when you (or the user) need a clean context now. Use\
  \ /end-session for canonical close."
---
