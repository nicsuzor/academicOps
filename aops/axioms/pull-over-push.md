---
trigger: always_on
description: Pull over push — injection-tier discipline
---
...
Standard fix for over-injection: split the compact floor cue (stays push) from elaboration, rationale, and checklists (demote to pull — referenced doc, PKB note, or skill body). For the enforcement cost model (the norms / cost / defaults / likelihood levers), see [enforcement.md](../../specs/enforcement/enforcement.md#what-actually-enforces-things-today).
