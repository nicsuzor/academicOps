...
| Downstream unblocking   | What this frees up                                          | `mcp__services__pkb__get_dependency_tree(id, direction='downstream')` to check, `depends_on` edges from other nodes to record it                |
