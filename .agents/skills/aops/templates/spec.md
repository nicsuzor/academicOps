...
**Priority**: [P0 | P1 | P2 | P3 | P4] <!-- Canonical labels — see [TAXONOMY.md → Priority Labels](../../remember/references/TAXONOMY.md#priority-labels-p0p4). Agents never originate a non-default band; only Nic sets intent — [[framework-conventions-summary#intent-authority]]. -->
