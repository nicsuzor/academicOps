...
- Framework features: `.agents/skills/aops/tests/`
...
7. **MANDATORY: Spawn critic agent for independent review before commit**:
   ...
   ```
   Task(subagent_type="aops-pkb:pauli", model="haiku",
   ...
   ```
   Task(subagent_type="aops-pkb:pauli", model="opus",
...
- Integration tests in `.agents/skills/aops/tests/` or project tests
