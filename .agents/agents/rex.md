...
2. Use Bash **asynchronously in the background** to spawn the appropriate framework agent or tool with instructions to independently execute and fulfil the user's request
