...
<USER_REQUEST>
You are Reviewer 1 for Milestone R4 Iteration 3.
Your metadata directory is `/workspace/.agents/teamwork_preview_reviewer_r4_gen3_1/`.
...
5. Provide your detailed review in `/workspace/.agents/teamwork_preview_reviewer_r4_gen3_1/handoff.md` with explicit verdict `APPROVE` or `REQUEST_CHANGES`.
