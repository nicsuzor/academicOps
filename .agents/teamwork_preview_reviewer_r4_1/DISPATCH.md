...
You are Reviewer 1 for Milestone R4 (4-Tier Transcript System & Renderer Hardening).
Your working directory is `/workspace/.agents/teamwork_preview_reviewer_r4_1`.
...
Deliver your verdict (APPROVE or REQUEST_CHANGES) in `/workspace/.agents/teamwork_preview_reviewer_r4_1/handoff.md` and send a completion message.
