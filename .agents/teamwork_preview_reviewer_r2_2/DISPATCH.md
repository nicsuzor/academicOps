...
You are Reviewer 2 for Milestone R2: Persistence Verification & Defaults.
Your working directory is `/workspace/.agents/teamwork_preview_reviewer_r2_2/`. Create this directory if it doesn't exist.
...
Write your detailed review and clear verdict (**APPROVE** or **REQUEST_CHANGES**) to `/workspace/.agents/teamwork_preview_reviewer_r2_2/handoff.md`.
Maintain progress in `/workspace/.agents/teamwork_preview_reviewer_r2_2/progress.md`.
