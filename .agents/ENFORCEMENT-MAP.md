...
## PR-pipeline agents (v2 — proposed)
...
| ---------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------- | --------------------------------------------------------------- | ------- | -------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `enforcer-status` (rbg)            | `.github/workflows/agent-enforcer.yml@enforcer-v1` + `.github/agents/enforcer.agent.md` (sources `aops-core/agents/rbg.md`)                                                                                                   | A1, A6, A8 (axiom compliance, scope, halt); P#65 (enforcement-map row required for new agents)      | Every PR with non-doc-only diff                                 | `block` | L6 · ~1.5–3k tok + 5–30s per fire × 1 per HEAD SHA (SHA-skip dedupe)                               | Reviews PR diff against axioms. Posts GitHub PR review (APPROVED / CHANGES_REQUESTED) + `enforcer-status` on HEAD SHA. SHA-skip prevents double-review of unchanged HEAD.                                                                          |
