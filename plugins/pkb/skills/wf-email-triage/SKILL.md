...
description: "Triage an inbox — classify each message as Task, FYI, Skip, or Uncertain, infer a priority for the tasks, and create task records for them. Use when asked to triage, sweep, or process email, or to turn an inbox into a task list. This is a template to build on; a project may override the classification signals and priority rules in its own PKB."
id: wf-email-triage
kind: obligation
