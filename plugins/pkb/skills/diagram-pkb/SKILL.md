...
4. **Annotations**: Human commentary via sticky notes (`--preset sticky`). Use this to explain *why* a dependency exists, pulling from the task's context or rationale.
...
1. **Extract the Topology**:
   ...
   *Example: Generate a 2-hop neighborhood around a specific task.*
