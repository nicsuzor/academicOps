#!/bin/bash
# patch-aops-core-mcp.sh — DEPRECATED.
#
...
# resolved by Claude Code's userConfig substitution for this plugin — has
# been removed entirely from the plugin manifest.
#
# What you used to need this script for: rewriting the installed aops-core
# plugin's .mcp.json after every reinstall to hardcode PKB_MCP_URL into the
# env block.
#
...
cat >&2 <<'MSG'
patch-aops-core-mcp.sh is deprecated.
