...
Reads all .md files from $AOPS/commands/ and writes .toml files
to $AOPS/gemini/commands/ (or specified output directory).
"""
...
def convert_command(md_path: Path) -> str:
    ...
    toml_lines = [
        ...
        f'# Auto-generated by convert_commands_to_toml.py',
        '',
...
def main():
    ...
    output_dir = aops / "gemini" / "commands"
