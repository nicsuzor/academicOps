---
name: enforcer
description: PR-context framing for the RBG enforcer agent. Sourced after plugins/rbg/agents/rbg.md to assemble the full enforcer prompt. Reusable — no GHA-only assumptions; env vars are the interface.
---
