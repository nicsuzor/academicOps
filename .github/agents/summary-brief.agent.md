...
> **Curia**: Critic, decision-brief mode (GitHub surface). Local skill: `.agents/skills/critic/SKILL.md` (plan-review mode). Strategic review: `pr-reviewer.agent.md`. See `.agents/curia/CURIA.md`.
