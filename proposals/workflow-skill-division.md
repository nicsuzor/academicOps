...
| :------------------- | :--------------------------------------------------- | :-------------------------------- | :------------------------------------------------------------------------------------- |
| **`task-lifecycle`** | The default master workflow for all tracked work.    | `framework`, `handover`, `tasks`  | _New (consolidates fragmented lifecycle logic)_                                        |
...
_Note: `simple-question` remains as a lightweight routing fast-track for pure information requests._
