...
type: axioms
description: Core axioms and behavioral rules for the academicOps framework, including
  fail-fast philosophy, DRY principles, project isolation, standard tools, and tool
  failure protocols. Loaded by all agents via SessionStart.
tags:
  - axioms
  - principles
  - fail-fast
...
relations:
  - "[[core/_CORE]]"
  - "[[ARCHITECTURE]]"
permalink: aops/skills/tasks/resources/axioms
---
