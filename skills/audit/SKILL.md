...
**MANDATORY: Execute ALL 7 phases below.** Do NOT stop after Phase 0 (health metrics). The health script is just one input - you must complete Phases 1-7 to regenerate indices and produce the full audit report.
...
Verify `EXECUTION-FLOW.md` reflects actual hook architecture:
...
- EXECUTION-FLOW.md: [N] hooks in flow diagram
...
- `EXECUTION-FLOW.md` matches hooks/router.py dispatch table (regenerated via flowchart skill)
- Generated indices (INDEX.md, RULES.md, WORKFLOWS.md, EXECUTION-FLOW.md) include "Generated by audit" header
