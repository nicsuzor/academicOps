...
[2-3 sentence overview of case, key question, and strategic priority]
...
**Rule**
[Policy text + IHRL standard (ICCPR article, Rabat factor, etc.)]
...
**Conclusion**
[Why this reading of the rule applied to these facts yields this outcome]

### Position B (likely [minority/majority]): [OUTCOME]

**Rule**
[Alternative reading or different emphasis within same framework]
...
4. **Content**: [Degree and form of incitement]
5. **Extent**: [Reach and audience]
