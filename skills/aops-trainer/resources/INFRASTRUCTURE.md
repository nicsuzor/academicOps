...
- '[[AXIOMS]]'
- '[[AGENT-BEHAVIOR]]'
permalink: bots/chunks/infrastructure-1
---
...
├── bots/                   # Bot infrastructure (PUBLIC, git tracked)
...
Skills in `bots/skills/` are loaded via the Skill tool when needed. No automatic loading - explicit invocation only.