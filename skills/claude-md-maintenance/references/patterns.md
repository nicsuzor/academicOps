...
When debugging tests, use pytest -xvs flags for detailed output. Tests should be deterministic and not rely on timing or order.
```
...
Use type hints for all functions. Follow PEP 8 style guide. Write docstrings for public APIs.
...
@bots/prompts/PROJECT_overview.md @$ACADEMICOPS/bots/prompts/python_standards.md

## Infrastructure

@bots/prompts/PROJECT_docker_setup.md @bots/prompts/PROJECT_deployment.md
...
Remember to use real_bm fixture Don't forget about auth headers TODO: document the API NOTE: deployment needs AWS keys btw tests are flaky sometimes
```
...
@bots/prompts/PROJECT_test_fixtures.md @bots/prompts/PROJECT_api_auth.md @bots/prompts/PROJECT_deployment_requirements.md @bots/prompts/PROJECT_known_issues.md
```
...
@bots/prompts/PROJECT_setup.md @$ACADEMICOPS/bots/prompts/python_standards.md
