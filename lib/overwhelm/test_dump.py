...
data = {
    "active_agents": [{"session_id": a.session_id, "project": a.project, "started_at": a.started_at, "task_id": a.task_id} for a in dashboard.get_active_agents(max_age_hours=1)],
