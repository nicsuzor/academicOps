...
def extract_metadata_from_raw_events(session: NormalizedSession) -> dict[str, Any]:
    ...
    for raw_entry in session.raw_events:
        ...
        if entry_type == "pr-link":
            ...
            key = obj.get("settingKey") or obj.get("key") or obj.get("setting_key") or obj.get("name")
            ...
            name = obj.get("agentName") or obj.get("name") or obj.get("agent_name") or obj.get("value")
