...
- [[mcp__pkb__get_task_network]] - Tree retrieval for decomposition
- [[mcp__pkb__get_task_network]] - Graph neighborhood for relationship discovery
- [[mcp__pkb__create_task]] - Atomic decomposition tool
- [[mcp__pkb__get_task_network]] - Topology metrics for agent analysis
- [[mcp__pkb__get_network_metrics]] - Raw graph metrics for health analysis
