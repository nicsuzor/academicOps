...
- [[aops-core/skills/planning/workflows/decompose.md]] -- general decomposition workflow; this spec extends it with research primitives
  **2026-05-17 00:40 UTC** — [sleep 2026-05-17] Flagged as stale: `in_progress` since 2026-04-27 (≥20 days). Confirm whether still active or should be moved to `paused`/`ready`.
