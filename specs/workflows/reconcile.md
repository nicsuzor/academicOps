...
> **Rework status**: reworked and repackaged (output contract + when-to-include added) as the PKB template component `wf-reconcile`, read by the planner. Content otherwise preserved intact — this spec required minimal rework. This file remains the operative record.
