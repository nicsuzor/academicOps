...
- Regenerate index files (INDEX.md, `.agents/ENFORCEMENT-MAP.md`, WORKFLOWS.md, SKILLS.md)
...
- Hook/axiom mismatches (update hook or `.agents/ENFORCEMENT-MAP.md`?)
...
- [ ] All hooks with "Enforces:" declaration appear in `.agents/ENFORCEMENT-MAP.md`
- [ ] All axioms with Hard/Soft Gate in `.agents/ENFORCEMENT-MAP.md` have hook implementation
