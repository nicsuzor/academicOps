...
- Regenerate index files (INDEX.md, `specs/ENFORCEMENT-MAP.md`, WORKFLOWS.md, SKILLS.md)
...
- Hook/axiom mismatches (update hook or `specs/ENFORCEMENT-MAP.md`?)
...
- [ ] All hooks with "Enforces:" declaration appear in `specs/ENFORCEMENT-MAP.md`
- [ ] All axioms with Hard/Soft Gate in `specs/ENFORCEMENT-MAP.md` have hook implementation
