...
- **worker_name**: String identifier for the agent or human completing the work (e.g., `"Claude Opus 4.5"`, `"human"`). Used for attribution and resumption context. Use `null` if unknown.
