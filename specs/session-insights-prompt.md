...
Extract ALL Framework Reflection sections found in the transcript. These structured reflections are output by agents at session end (via `/handover` or `/learn` commands) and contain valuable session metadata.
