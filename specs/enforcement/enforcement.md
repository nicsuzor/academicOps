...
flowchart TD
  ...
  subgraph L4[L4 Soft gates]
    GATES["rbg gate, task-binding gate (reactivated, H4), QA gate, unified logger, premise gate (spend-surface refusal)"]
  end
...
| :---------------------------------------------------------------------------------------------------------------------------------------------------------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :-------------------------------------------------------- | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :--------- | :------------------------------------------------------------------------------------------------------------------------------------- |
| `rbg` gate                                                                                                                                                  | Periodic PreToolUse compliance re-audit; dispatches the `rbg` subagent every N write ops.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | All axioms                                                | `gates.rbg_threshold` — explicit, no default under `polecat.yaml` (`gate_config.py:_RBG_THRESHOLD_DEFAULT` is a direct-CLI-only fallback)                                                                                               | Middle     | [`GATES.md#rbg-gate`](GATES.md#rbg-gate)                                                                                               |
