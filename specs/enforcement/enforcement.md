...
5. **`structural check`** -- code-level guarantee holding regardless of agent cooperation (mount permissions, fail-closed configs, native loaders, sandbox network allowlists).
