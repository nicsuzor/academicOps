...
| mechanic (split)   | L4 | —      | Post-admission dev/conflict-resolve; rebase split       | planned; not built — name **settled "mechanic"** (`mechanic-status`, non-required)                                                                                                               | `.github/workflows/agent-mechanic.yml` absent; live merge-prep still does this                                    |
