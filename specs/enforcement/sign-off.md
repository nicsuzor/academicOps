...
> **Numbering note.** `Layer 4` here belongs to the **module-boundary layer model** (`Layer 0`–`Layer 4`: the trust-the-method intra-task/turn span, [task-contract.md](task-contract.md), [workflow.md](workflow.md), this file) — a different axis from any pipeline/pyramid numbering that may appear elsewhere.
