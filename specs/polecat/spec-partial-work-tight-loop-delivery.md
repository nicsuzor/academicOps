...
The stop gate is governed by clauses that are **instruction-led and honesty-audited, NOT regex/keyword-matched** (per No-Shitty-NLP P#49 — instruction-led register, mechanical tiering explicitly not wanted). The honesty floor (ida, always-on) audits the worker's self-certification.
