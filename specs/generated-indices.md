...
Audit skill reads sources, computes indices
    ↓
Generated indices (INDEX.md, RULES.md, WORKFLOWS.md)
    ↓
...
1. Generated indices live at root level (not in config/ or generated/)
...
- `config/workflows.md` exists (just created, wrong location)

Target state:
- Move `config/workflows.md` → `WORKFLOWS.md`
- Add "Generated by audit" header to all three
