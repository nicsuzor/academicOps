...
│                                                                         │
│  Dashboard reads $AOPS_SESSIONS/summaries/*.json directly at render     │
│  time — no intermediary synthesis step needed.                          │
│                                                                         │
│  Daily narrative (daily_story, daily_narrative) lives in the daily      │
│  note frontmatter, not in session summary files.                        │
└─────────────────────────────────────────────────────────────────────────┘
                                    │
                                    ▼
┌─────────────────────────────────────────────────────────────────────────┐
...
5. **Update enforcement-map** - If observable enables new enforcement:
   - Add entry to `specs/ENFORCEMENT-MAP.md` (operative SSoT)
