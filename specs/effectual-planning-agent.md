...
5. ~~**Daily skill alignment.**~~ **Resolved.** The daily note uses priority-based task recommendations (SHOULD/DEEP/ENJOY/QUICK/UNBLOCK categories). The planner's information-value lens complements the daily skill's operational awareness.
