...
The framework's canonical agent roster and their individual specifications have been consolidated under [[agents|Agent Ecosystem Specification]] and their respective files:

- **[[junior|Junior]]** (`specs/agents/junior.md`) — Framework coordinator and default interactive head.
- **[[ida|Ida]]** (`specs/agents/ida.md`) — Interactive academic-research co-worker.
- **[[pauli|Pauli]]** (`specs/agents/pauli.md`) — Architect of Thought and Memory (Planner / Custodian).
- **[[rbg|RBG]]** (`specs/agents/rbg.md`) — Axiom violation Judge.
- **[[marsha|Marsha]]** (`specs/agents/marsha.md`) — QA Reviewer (Runtime Verifier).
- **[[james|James]]** (`specs/agents/james.md`) — Orchestrator and synthesis review reconciler.

For the active permissions and capabilities, consult [[agent-compliance-matrix]].
