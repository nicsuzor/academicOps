...
- **Runtime Definition**: `aops-pkb/agents/pauli.md` — the operative persona and the single copy of Pauli's operating rules (PKB curation, strategic review protocol, planning/dispatch discipline).
