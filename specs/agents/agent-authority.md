...
- `pc` (`plugins/ida/agents/pc.md`) declares `tools: [Bash]` with explicit `bashScopes: [tmux, uv, git]`, and pairs `permissionMode: "dontAsk"` with `allowedTools: [Bash(tmux *), Bash(uv run *), Bash(git *)]`.
