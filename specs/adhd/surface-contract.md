...
| :--------------------------------------------------- | :------------------------------ | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `rbg` (enforcer) · block (PreToolUse)                | `ephemeral`                     | `permissionDecisionReason`: "✕ 0 remaining — compliance check now required (threshold N reached, M ops since last check)." (`rbg.policy_message`, aops_47d0a754 — down-to-zero framing). Agent separately gets the compliance-report dispatch instruction via `additionalContext` (`rbg.policy_context`).                                                      |
...
| `qa` · warn (Stop)                                   | `silent` (intended; see caveat) | Non-blocking `additionalContext` delivery — same caveat as `ida` warn below.                                                                                                                                                                                     |
...
| `handover` · warn (Stop)                             | `silent` (intended; see caveat) | Non-blocking `additionalContext` delivery — same caveat as `ida` warn below.                                                                                                                                                                                     |
...
| `rbg_review` · warn (Stop)                           | `silent` (intended; see caveat) | Non-blocking `additionalContext` delivery — same caveat as `ida` warn above.                                                                                                                                                                                     |
