...
4. **Verification via Review**: Correctness of the plan against these constraints must be verified qualitatively by the user or by invoking the `qa` skill during the planning phase.
