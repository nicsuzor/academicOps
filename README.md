...
flowchart TD
    ...
    P2 --> P3["<b>3. Dispatch & Containerize</b><br/>(ida / polecat)<br/>Runs isolated in Docker container,<br/>updates PKB, commits & pushes"]
...
`rbg`, `tools`, `ts`, and `aops-debug` install the same way.
