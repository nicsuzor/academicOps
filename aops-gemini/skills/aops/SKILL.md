...
- On first invocation, load the framework state document: `mcp_pkb_get_document(id="aops-state")`.
- Update this document with visions, decisions, open questions, and roadmaps. Use `mcp_pkb_append` for incremental updates.
