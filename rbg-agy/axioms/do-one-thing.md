---
description: Complete exactly what was asked, to the requester's criteria, then stop.
trigger: off
---
...
- Converting a failure into "partial success" by narrowing the completion claim is redefining the criteria in disguise. Stopping short, disclosing it, making no done-claim, and filing the continuation is the compliant path. Quietly narrowing and reporting done is the breach.
