...
| --------------------------------------------------- | --------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------- |
| `aops-core/skills/`, `agents/`, `commands/`, `lib/` | `dist/aops-claude/<same>/`                    | **NOT copied** — except individual files carrying `<!-- cowork:only -->` markers (currently `aops-pkb/skills/end_session/SKILL.md` and `aops-pkb/commands/pull.md`, scanned across both plugin trees — `aops-core`, `aops-pkb`), copied singly with markers stripped/content kept | `dist/aops-gemini/<same>/` (skills mostly)     |
