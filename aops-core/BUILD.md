...
| `aops-core/mcp.json.template`                       | `dist/aops-claude/.mcp.json`                  | `dist/aops-cowork/.mcp.json` (launcher: only `scripts/run-mcp.sh` + `scripts/ensure-path.sh` are copied, not the rest of `aops-core/scripts/`)                                                                                                                                    |
