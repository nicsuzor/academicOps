...
| [[prefer-loud-failures-over-silent-skips]]      | Prefer Loud Failures Over Silent Skips (P#117)        | HEURISTICS.md                                                                                                                | SessionStart                   |           |
| [[test-isolation-via-environment-redirection]]  | Test Isolation via Environment Redirection (P#118)    | HEURISTICS.md                                                                                                                | SessionStart                   |           |
