...
- **Session continuations**: If the narrative contains a compaction summary from a prior session, previous enforcer blocks are RESOLVED. Focus on current activity, not historical events.
