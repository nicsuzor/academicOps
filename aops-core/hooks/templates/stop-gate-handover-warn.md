...
You are stopping the session, but the `handover` skill has not been invoked. We have not been able to locate the handover information in the right format in your output so far.
