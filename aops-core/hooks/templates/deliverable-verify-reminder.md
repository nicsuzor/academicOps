---
name: deliverable-verify-reminder
title: Deliverable-Verify — Honesty/Verdict Check on SubagentStop
category: template
description: |
  Advisory context injection fired when a (non-compliance) subagent stops.
  Reminds the orchestrator to audit the subagent's actual deliverable before
  relaying its verdict, rather than accepting it as fact (task-1029fccb).
---
