...
| **Auto-update**             | marketplace pin pulled by `claude plugin marketplace update`                                 | same as CLI                                                                                 | **None** — uploaded zip is pinned to whatever was uploaded; never auto-updates                                                |
