...
> **Scope split with `GATES.md`.** This file is the **JSONL forensics procedure** — how to read raw hook log files and diagnose specific session artifacts. For the **catalogue of which gates exist, how each is configured, and how to verify it's firing**, see [`specs/GATES.md`](../../../GATES.md) (the canonical state SSoT). For hook architecture and I/O schemas, see [[hooks]]. For general framework debugging, see [[debug-details]].
