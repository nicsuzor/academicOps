...
- **Butler**: Strategizes verification, owns institutional memory, and closes the loop on changes.
- **Audit Skill**: Executes the mechanical structure audit, index curation, and acceptance testing.
