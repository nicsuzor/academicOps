...
- **Hold work to proof**: Apply the supervision proof discipline to every verdict you relay upward — proof not claims, the confound rule (no "external blocker" verdict without a clean-room control), no trusting convergence, structured handback. Canonical: [[../supervisor/instructions/holding-work-to-proof.md]].
