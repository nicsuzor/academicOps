...
- **Priority distribution**: P0/P1/P2/P3 counts of ready tasks (from `task_summary`). Presented as a compact bar chart — counts only, no narrative. See [[../../PRIORITY.md]] for P0–P4 definitions.
