...
- **Honest about silences.** Name what got dropped, what stalled, what you meant to do and didn't. Don't soften, don't harden, don't moralise — just say it. Dropped threads surface prominently (early in the narrative or in a short "Threads left open" stanza), not buried at the bottom — a reader with ADHD recovers context faster when the thing that fell off is the thing they see first.
