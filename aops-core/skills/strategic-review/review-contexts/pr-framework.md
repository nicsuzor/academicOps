...
- **`exercise-authority` Edge 3 (script abdication)**: did the PR introduce regex/keyword/checklist scaffolding for a decision that requires qualitative judgment? An agent invocation may be the more accurate (and sometimes cheaper) path; recommend it where applicable.
