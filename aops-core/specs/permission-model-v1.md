...
1. **Search existing tasks**: `mcp__plugin_aops-core_tasks__search_tasks(query="keyword")`
2. **Claim existing**: `mcp__plugin_aops-core_tasks__update_task(id="...", status="active")`
3. **Or create new**: `mcp__plugin_aops-core_tasks__create_task(...)`
