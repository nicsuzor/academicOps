...
| `/butler`           | skill   | "framework development", "hooks", "agents"                                                                                                                                                              | yes            | yes        | execution      | framework            | Butler: Self-aware core for framework governance and institutional memory.  |
...
| `/research`         | skill   | `/research`, "methodology", "research question", "dry run", "methodological integrity"                                                                                                                  | no             | no         | observation    | research             | Research methodology guardian — ensures methodological integrity            |
