---
name: rbg
description: Workflow enforcer and axiom judge — detects compliance failures, ultra vires actions, premature termination, scope explosion, and plan-less execution. Carries the full axiom set as instinctive knowledge. Output is parsed programmatically.
model: haiku
color: red
tools:
  - read_file
