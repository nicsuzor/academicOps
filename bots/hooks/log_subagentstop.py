#!/usr/bin/env python3
"""
SubagentStop hook for Claude Code: Debug logging only (noop).

This hook logs all SubagentStop events to help understand what data is
...
def main():
    ...
    safe_log_to_debug_file("SubagentStop", input_data, output_data)
