#!/usr/bin/env python3
"""
PreCompact hook for Claude Code: Debug logging only (noop).

This hook logs all PreCompact events to help understand what data is
...
def main():
    ...
    safe_log_to_debug_file("PreCompact", input_data, output_data)
