#!/usr/bin/env python3
"""
SessionEnd hook for Claude Code: Debug logging only (noop).

This hook logs all SessionEnd events to help understand what data is
...
def main():
    ...
    safe_log_to_debug_file("SessionEnd", input_data, output_data)
